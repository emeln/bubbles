...
class WindowFunctions(object):
    ...
    def set_window_functions(object, window_function, cosmo):
        """
        Looks like the density of the haloes are rho_mean here, which seems strange to me. Shouldn't the density of
        the haloes be denser than the average density of the universe?
        """
